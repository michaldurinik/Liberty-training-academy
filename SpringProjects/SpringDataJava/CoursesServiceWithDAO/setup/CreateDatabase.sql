...
CREATE TABLE Deliveries(DeliveryNum BIGINT PRIMARY KEY, TrainingProgramNum BIGINT DEFAULT NULL, StartDate DATE, EndDate DATE, CourseNum VARCHAR(10));
CREATE TABLE RecommendedReading(CourseNum VARCHAR(10), Description VARCHAR(100));
CREATE TABLE Instructors(CourseNum VARCHAR(10), Position INT, Name VARCHAR(100));
CREATE TABLE FeedbackOnDelivery(DeliveryNum BIGINT, DelegateName VARCHAR(100), Feedback VARCHAR(200));
CREATE TABLE TrainingPrograms(TrainingProgramNum BIGINT PRIMARY KEY, Name VARCHAR(100));
...
INSERT INTO TrainingPrograms (TrainingProgramNum, Name) VALUES (12,'C++ Reskilling');
...
INSERT INTO RecommendedReading (CourseNum, Description) VALUES ('AB12','C++ Primer by Stanley Lippman');
INSERT INTO RecommendedReading (CourseNum, Description) VALUES ('AB12','The C++ Standard by British Standards Institute');
INSERT INTO RecommendedReading (CourseNum, Description) VALUES ('AB12','The C++ Programming Language by Bjarne Stroustrup');

INSERT INTO Instructors (CourseNum, Position, Name) VALUES ('AB12',0,'Joe Bloggs');
INSERT INTO Instructors (CourseNum, Position, Name) VALUES ('AB12',1,'Jane Smith');
INSERT INTO Instructors (CourseNum, Position, Name) VALUES ('AB12',2,'Fred Hayes');

INSERT INTO FeedbackOnDelivery (DeliveryNum, DelegateName, Feedback) VALUES (1001,'Homer','Great course');
INSERT INTO FeedbackOnDelivery (DeliveryNum, DelegateName, Feedback) VALUES (1001,'Marge','Good course');
INSERT INTO FeedbackOnDelivery (DeliveryNum, DelegateName, Feedback) VALUES (1001,'Bart','OK course');
INSERT INTO FeedbackOnDelivery (DeliveryNum, DelegateName, Feedback) VALUES (1001,'Liza','Poor course');